...
class ProductListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Dummy products for now. Replace with actual data.
    final products = List.generate(10, (index) => {'id': index, 'name': 'Product $index'});

    return Scaffold(
      appBar: AppBar(title: Text(Strings.products)),
